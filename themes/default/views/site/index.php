...
<div class="main">
    ...
    <div class="toutiao">
        ...
        <div>
            ...
            <a target="_blank" title="婚纱摄影 中山婚纱照 拍摄婚纱照" href="#">
                <img width="540" height="467" alt="婚纱摄影 中山婚纱照 拍摄婚纱照" src="<?php echo $this->_baseUrl ?>/images/ad_001.jpg" style="opacity: 1;">
            </a>
    ...
    <div class="event">
        ...
        <div class="event_m">
            ...
            <div class="event_b">
                <ul>
                    <li><a target="_blank" title="中山婚纱摄影 最新动态 中山婚纱摄影工作室" href="event_view_218.html"><img width="92" height="92" alt="中山婚纱摄影 最新动态 中山婚纱摄影工作室" src="upload/small/201407/201407021404271745.jpg"><div class="nr"><b>9周年店庆·拍婚纱照送微电影</b><i>HITS:8208 </i><small>TIME:2014-07-02</small><div class="clear"></div><p>丘比特婚纱9岁店庆啦!【拍婚纱照送微电影】活动时间7.1-7.20 限量抢订，订完即止！活动期间进店订单另有机会获得大钻戒...</p></div></a></li>
                    <li><a target="_blank" title="中山婚纱摄影 最新动态 中山婚纱摄影工作室" href="event_view_205.html"><img width="92" height="92" alt="中山婚纱摄影 最新动态 中山婚纱摄影工作室" src="upload/small/201406/201406081402200314.jpg"><div class="nr"><b>2014广州夏季结婚展</b><i>HITS:1512 </i><small>TIME:2014-06-08</small><div class="clear"></div><p>2014广州夏季结婚展...</p></div></a></li>
                    <li><a target="_blank" title="中山婚纱摄影 最新动态 中山婚纱摄影工作室" href="event_view_192.html"><img width="92" height="92" alt="中山婚纱摄影 最新动态 中山婚纱摄影工作室" src="upload/small/201404/201404281398678218.jpg"><div class="nr"><b>盛夏光年,蜜爱五月--你好，蔓延！</b><i>HITS:8946 </i><small>TIME:2014-04-28</small><div class="clear"></div><p>...</p></div></a></li>
...
<div class="main">
    <div class="works1">
        ...
        <ul>
            <li><a target="_blank" title="中山婚纱摄影 最新动态 中山婚纱摄影工作室" href="#">
                    <img width="240" height="336" alt="中山婚纱摄影 最新动态 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_001.jpg">
                    <span class="png" style="bottom: -64px;"><b>CHENGXILI</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="#">
                    <img width="240" height="336" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_002.jpg">
                    <span class="png" style="bottom: -64px;"><b>ZETING</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="#">
                    <img width="240" height="336" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_003.jpg">
                    <span class="png" style="bottom: -64px;"><b>XUWANA</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="#">
                    <img width="240" height="336" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_004.jpg">
    ...
    <div class="works2">
        ...
        <ul>
            <li><a target="_blank" title="中山婚纱摄影 丘比特婚纱 最新作品 中山婚纱摄影工作室" href="works_view_422.html">
                    <img width="239" height="349" alt="中山婚纱摄影 丘比特婚纱 最新作品 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_005.jpg">
                    <span class="png" style="bottom: -64px;"><b>温柔的遇见</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新样片 中山婚纱摄影工作室" href="works_view_421.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新样片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_006.jpg">
                    <span class="png" style="bottom: -64px;"><b>最甜的微笑</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_419.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_007.jpg">
                    <span class="png" style="bottom: -64px;"><b>拥抱的初触动</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_420.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_008.jpg">
    ...
    <div class="works4">
        ...
        <ul>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_413.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_009.jpg">
                    <span class="png" style="bottom: -64px;"><b>ZHAOCHUN</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_405.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_010.jpg">
    ...
    <div class="works3">
        ...
        <ul>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_414.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_013.jpg">
                    <span class="png" style="bottom: -64px;"><b>DUMING</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_411.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_014.jpg">
                    <span class="png" style="bottom: -64px;"><b>GUOXHUNYAN</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_407.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_015.jpg">
                    <span class="png" style="bottom: -64px;"><b>FENGSHENGSI</b></span></a></li>
            <li><a target="_blank" title="中山婚纱摄影 最新客片 中山婚纱摄影工作室" href="works_view_398.html">
                    <img width="239" height="349" alt="中山婚纱摄影 最新客片 中山婚纱摄影工作室" src="<?php echo $this->_baseUrl ?>/images/photo_016.jpg">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".works1 ul li a").hover(function(){


            $(this).find("span").stop().animate({bottom:"130px"},500);

        },function(){

            $(this).find("span").stop().animate({bottom:"-64px"},500);

        })

        $(".works2 ul li a").hover(function(){
        ...
        $(".works_list dl dd a").hover(function(){
        ...
        $(".scene_i ul li a").hover(function(){


            $(this).find("span").stop().animate({bottom:"80px"},500);

        },function(){

            $(this).find("span").stop().animate({bottom:"-51px"},500);
